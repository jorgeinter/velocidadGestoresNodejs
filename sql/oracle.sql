...
-- Paso 1: Crear los tablespaces (contenedores de almacenamiento) (opcional)
...
-- Paso 2: Crear un usuario y asignarle los tablespaces
...
-- Conectarse como SYSDBA y dar cuota ilimitada (si es necesario) al usuario
ALTER USER C##dbproducto QUOTA UNLIMITED ON users;

-- Paso 4: Crear la tabla (esto debe hacerse después de conectarse como el usuario C##ubdproducto)
